...
def main():
    ...
    camera.set(3, 640)  # 가로 해상도 640 픽셀 설정
    camera.set(4, 480)  # 세로 해상도 480 픽셀 설정
    ...
    while camera.isOpened():  # 카메라 열려있는 동안 반복
        ...
        print("faces detected Number: " + str(len(faces)))  # 탐지 된 얼굴 수 터미널 출력
